          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">বিক্রয়ের তালিকা</h3>
              </div>
              ...
              <div class="card-body">
                ...
                <a href="sales_form.php" type="submit" name="save" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> যুক্ত করুন</a>
                </div>
                  <style>
                  table {
                ...
                ?>
                  <tr>
                   ...
                   <button data-id='<?php echo $rows["id"]?>' class='dropdown-item fas fa-eye userinfo'> Details</button>
